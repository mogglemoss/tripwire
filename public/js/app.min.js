...
tripwire.comments=function(){this.comments.data={},this.comments.parse=function(t){function e(t){const e=["b","i","em","strong","font","s","pre","span","p","br","h1","h2","h3","h4","h5","h6","table","tr","td","th","thead","tbody","div","a","img"];return t.replaceAll(/<\s*(\/?)\s*(\w+)([^>]*)>/g,(t,i,m,o)=>e.indexOf(m)>=0?t:"").replaceAll(/(on\w+)=/g,"x_$1=")}for(var i in t){var m=t[i].id;if(Object.find(tripwire.comments.data,"id",m)||0!=$(".comment[data-id='"+m+"']").length){if(Object.find(tripwire.comments.data,"id",m)&&Object.find(tripwire.comments.data,"id",m).modified!=t[i].modified){o=$(".comment[data-id='"+m+"']");try{o.find(".commentBody").html(e(t[i].comment))}catch(t){o.find(".commentFooter").show(),o.find(".commentStatus").html("<span class='critical'>"+t.constructor.name+": "+t.message+"</span>"),o.find(".commentFooter .commentControls").hide()}o.find(".commentModified").text("Edited by "+t[i].modifiedByName+" at "+t[i].modified),o.find(".commentSticky").addClass(t[i].sticky?"active":"")}}else{var o=$(".comment:last").clone(),d=$(".comment:visible:last .commentBody").attr("id")?$(".comment:visible:last .commentBody").attr("id").replace("comment","")+1:0;$(".comment:last").before(o),o.attr("data-id",m);try{o.find(".commentBody").html(e(t[i].comment))}catch(t){o.find(".commentFooter").show(),o.find(".commentStatus").html("<span class='critical'>"+t.constructor.name+": "+t.message+"</span>"),o.find(".commentFooter .commentControls").hide()}o.find(".commentModified").text("Edited by "+t[i].modifiedByName+" at "+t[i].modified),o.find(".commentCreated").text("Posted by "+t[i].createdByName+" at "+t[i].created),o.find(".commentBody").attr("id","comment"+d),o.find(".commentSticky").addClass(t[i].sticky?"active":""),o.removeClass("hidden"),Tooltips.attach(o.find("[data-tooltip]"))}}for(var i in tripwire.comments.data){m=tripwire.comments.data[i].id;if(!Object.find(t,"id",m))(o=$(".comment[data-id='"+m+"']")).remove()}tripwire.comments.data=t}},tripwire.comments();
