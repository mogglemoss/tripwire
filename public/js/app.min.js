...
!function(){var e,t,n,a,o=[],s=0;function d(e){o=function(e){var t=(e||"").toLowerCase().trim();return tripwire.keyboard.actions.filter(function(e){return!t||e.label.toLowerCase().indexOf(t)>-1||e.group.toLowerCase().indexOf(t)>-1}).concat(tripwire.keyboard.systemActions(t))}(e),s=0,o.length?n.html(o.map(function(e,t){return'<li role="option" class="'+(0===t?"sel ":"")+(e.enabled&&!e.enabled()?"off ":"")+(e.destructive?"danger":"")+'" aria-selected="'+(0===t)+'"><span class="cmd-label">'+e.label+'</span><span class="cmd-group">'+e.group+"</span>"+(e.keys?'<span class="cmd-keys">'+e.keys+"</span>":"")+"</li>"}).join("")):n.html('<li class="cmd-empty" role="presentation">No matching command</li>')}function l(e){o.length&&(s=(s+e+o.length)%o.length,n.children().removeClass("sel").attr("aria-selected","false").eq(s).addClass("sel").attr("aria-selected","true")[0].scrollIntoView({block:"nearest"}))}function i(e){var t=o[e];t&&(t.enabled&&!t.enabled()||(c(),t.perform()))}function r(){a.addClass("hidden"),e.removeClass("hidden"),t.val(""),d(""),t.focus()}function c(){e.addClass("hidden"),t.blur()}function p(){return e&&!e.hasClass("hidden")}$(function(){e=$('<div id="cmd-palette" class="hidden" role="dialog" aria-modal="true" aria-label="Command palette"><div class="cmd-box"><input id="cmd-input" type="text" autocomplete="off" spellcheck="false" placeholder="Type a command, or a system name to jump to…" aria-label="Command" /><ul id="cmd-list" role="listbox"></ul><div class="cmd-foot"><span><b>↑↓</b> move</span><span><b>↵</b> run</span><span><b>esc</b> close</span><span><b>?</b> shortcuts</span></div></div></div>').appendTo("body"),t=e.find("#cmd-input"),n=e.find("#cmd-list"),e.on("mousedown",function(t){t.target===e[0]&&c()}),t.on("input",function(){d(t.val())}),n.on("mousedown","li",function(e){e.preventDefault(),i($(this).index())}),(a=$('<div id="cmd-help" class="hidden" role="dialog" aria-label="Keyboard shortcuts"><div class="cmd-box"><h2>Keyboard shortcuts</h2><table>'+tripwire.keyboard.bindings.map(function(e){return"<tr><th>"+e.keys+"</th><td>"+e.does+"</td></tr>"}).join("")+"</table><p>Every command is also in the palette — press <b>/</b>.</p></div></div>").appendTo("body")).on("mousedown",function(e){e.target===a[0]&&a.addClass("hidden")}),t.on("keydown",function(e){"Escape"===e.key?(e.preventDefault(),c()):"ArrowDown"===e.key?(e.preventDefault(),l(1)):"ArrowUp"===e.key?(e.preventDefault(),l(-1)):"Enter"===e.key&&(e.preventDefault(),i(s))}),$(document).on("keydown.cmdPalette",function(e){if("Escape"===e.key){if(!a.hasClass("hidden"))return void a.addClass("hidden");if(p())return void c()}p()||tripwire.keyboard.isTyping(e.target)||((!e.ctrlKey&&!e.metaKey||"k"!==e.key&&"K"!==e.key)&&(e.ctrlKey||e.metaKey||e.altKey||"/"!==e.key)?e.ctrlKey||e.metaKey||e.altKey||"?"!==e.key||(e.preventDefault(),a.toggleClass("hidden")):(e.preventDefault(),r()))})})}();
