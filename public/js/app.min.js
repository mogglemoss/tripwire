...
const maskRendering=new function(){this.renderMask=function(e){return'<span class="mask" data-mask="'+e.mask+'"><i data-icon="'+{global:"eye",character:"user",corporate:"star",alliance:"star"}[e.ownerType]+'" class="'+e.ownerType+'"></i>'+e.label+"</span>"},this.update=function(e,n){const a=e.find(e=>void 0!==n?e.mask===n:e.active);document.getElementById("mask").innerHTML=maskRendering.renderMask(a);const t=document.getElementById("mask-menu-mask-list");t.innerHTML="",e.filter(e=>e.owner||e.joined||"alliance"==e.joinedBy||e==a).map(e=>{const n=document.createElement("a");n.href="#",n.innerHTML=this.renderMask(e),e===a&&(n.className="active"),n.addEventListener("click",n=>{maskFunctions.updateActiveMask(e.mask,()=>document.getElementById("mask-menu").style.display="none")}),t.appendChild(n)})}};
