...
!function(){function t(t){t&&t.trim()?(Notify.trigger("Paste detected<br/>(<a id='fullPaste' href=''>Click to delete missing sigs</a>)"),$("#fullPaste").data("paste",t),tripwire.pasteSignatures.parsePaste(t)):Notify.trigger("Nothing on the clipboard looked like scanner results.")}function e(){$("#clipboard").focus(),Notify.trigger("Press Ctrl-V (or &#8984;V) now to paste your scan results.")}$(function(){$(document).on("click","#paste-signatures",function(i){i.preventDefault(),navigator.clipboard&&navigator.clipboard.readText?navigator.clipboard.readText().then(t,e):e()})})}();
