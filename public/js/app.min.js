...
function commentSortHandler(t){const e=document.getElementById("comment-sort"),o=document.getElementById("comment-container");switch(t=t||e.nextSort||tripwire.cookies.getCookie("commentSort")||"asc"){case"asc":e.nextSort="desc",e.setAttribute("data-icon","sort-asc"),o.style.flexDirection="column";break;case"desc":e.nextSort="asc",e.setAttribute("data-icon","sort-desc"),o.style.flexDirection="column-reverse";break;default:throw"sort order somehow wrong"}tripwire.cookies.setCookie("commentSort",t,3650)}$("body").on("dblclick",".comment",function(t){t.preventDefault(),document.getSelection().removeAllRanges(),$(this).find(".commentEdit").click()}),$("body").on("click",".commentEdit",function(t){if(t.preventDefault(),$(".rte").length)return!1;var e=$(this).closest(".comment");e.find(".commentToolbar").hide(),tripwire.editor.replace(e.find(".commentBody").attr("id"),function(){e.find(".commentStatus").text(""),e.find(".commentFooter").show(),e.find(".commentFooter .commentControls").show()}),tripwire.activity.editComment=e.data("id"),tripwire.refresh("refresh")}),$("body").on("click",".commentSave, .commentCancel",function(t){t.preventDefault();var e=$(this);if(e.attr("disabled"))return!1;var o=e.closest(".comment");if(e.attr("disabled","true"),e.hasClass("commentSave")){var n={mode:"save",commentID:o.data("id"),systemID:o.find(".commentSticky").hasClass("active")?0:viewingSystemID,comment:tripwire.editor.get(o.find(".commentBody").attr("id")).getData()};$.ajax({url:"comments.php",type:"POST",data:n,dataType:"JSON"}).done(function(t){t&&1==t.result&&(o.find(".commentModified").text("Edited by "+t.comment.modifiedByName+" at "+t.comment.modifiedDate),o.find(".commentCreated").text("Posted by "+t.comment.createdByName+" at "+t.comment.createdDate),Tooltips.attach(o.find("[data-tooltip]")),tripwire.editor.destroy(o.find(".commentBody").attr("id"),!1),o.attr("data-id",t.comment.id),o.find(".commentToolbar").show(),o.find(".commentFooter").hide(),e.removeAttr("disabled"))})}else tripwire.editor.destroy(o.find(".commentBody").attr("id"),!0),o.attr("data-id")?(o.find(".commentToolbar").show(),o.find(".commentFooter").hide(),e.removeAttr("disabled")):o.remove();o.find(".commentStatus").text(""),delete tripwire.activity.editComment,tripwire.refresh("refresh")}),$("body").on("click",".commentDelete",function(t){t.preventDefault();var e=$(this).closest(".comment");$("#dialog-deleteComment").hasClass("ui-dialog-content")?$("#dialog-deleteComment").dialog("isOpen")||$("#dialog-deleteComment").data("comment",e).dialog("open"):$("#dialog-deleteComment").data("comment",e).dialog({resizable:!1,minHeight:0,position:{my:"center",at:"center",of:$("#notesWidget")},dialogClass:"dialog-noeffect ui-dialog-shadow",buttons:{Delete:function(){$("#dialog-deleteComment").parent().find(":button:contains('Delete')").button("disable");var t=$(this).data("comment"),e={mode:"delete",commentID:t.data("id")};$.ajax({url:"comments.php",type:"POST",data:e,dataType:"JSON"}).done(function(e){e&&1==e.result&&($("#dialog-deleteComment").dialog("close"),t.remove())}).always(function(){$("#dialog-deleteComment").parent().find(":button:contains('Delete')").button("enable")})},Cancel:function(){$(this).dialog("close")}}})}),$("body").on("click","#add-comment",function(t){if(t.preventDefault(),$(".rte").length)return!1;var e=$(".comment:last").clone(),o=$(".comment:visible:last .commentBody").attr("id")?$(".comment:visible:last .commentBody").attr("id").replace("comment","")+1:0;$(".comment:last").before(e),e.find(".commentBody").attr("id","comment"+o),e.removeClass("hidden").find(".commentEdit").click()}),$("body").on("click",".commentSticky",function(t){t.preventDefault();var e=$(this).closest(".comment"),o={mode:"sticky",commentID:e.data("id"),systemID:e.find(".commentSticky").hasClass("active")?viewingSystemID:0};$.ajax({url:"comments.php",type:"POST",data:o,dataType:"JSON"}).done(function(t){t&&1==t.result&&(e.find(".commentSticky").hasClass("active")?e.find(".commentSticky").removeClass("active"):e.find(".commentSticky").addClass("active"))})}),$("body").on("click","#comment-sort",function(t){commentSortHandler(void 0)}),commentSortHandler();
!function(){var t=["save","add","ok","apply","create","confirm"],e=["delete","remove","reset"];function o(){$(".ui-dialog-buttonpane button").each(function(){var o=$.trim($(this).text()).toLowerCase();$(this).toggleClass("is-primary",t.indexOf(o)>-1).toggleClass("is-destructive",e.indexOf(o)>-1)})}$(function(){$(document).on("dialogopen",".ui-dialog",function(){setTimeout(o,0)}),$(document).on("click",".ui-dialog-buttonpane button",function(){setTimeout(o,0)})})}();
