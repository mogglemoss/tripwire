...
!function(){function e(){var e=$("#hdr-ship");if(e.length){var t=window.tripwire&&tripwire.esi&&tripwire.esi.characters,i=t&&window.options&&options.tracking?t[options.tracking.active]:null,a=i&&i.shipTypeName;if(a){var r=$("<span/>").text(a).prop("outerHTML");i.shipName&&i.shipName!==a&&(r+='<span class="sep">·</span>'+$('<span class="shipname"/>').text(i.shipName).prop("outerHTML")),e.html(r).removeClass("hidden")}else e.addClass("hidden").empty()}}$(function(){if(e(),window.MutationObserver){var t={childList:!0,characterData:!0,subtree:!0,attributes:!0};["tracking","user-track"].forEach(function(i){var a=document.getElementById(i);a&&new MutationObserver(e).observe(a,t)})}})}();
