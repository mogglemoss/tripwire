...
var systemFit=new function(){var t=.46,i=.64,e=null,n=this;function r(){return document.querySelector("#infoWidget > .content.sys-panel")}function a(t){return parseFloat(t)||0}function o(t){var i=getComputedStyle(t),e=a(i.paddingTop)+a(i.paddingBottom),n=a(i.rowGap),r=0;return Array.prototype.forEach.call(t.children,function(t){var i=getComputedStyle(t);"none"!==i.display&&(r++,e+=a(i.marginTop)+a(i.marginBottom),"activityGraph"!==t.id&&(e+=t.getBoundingClientRect().height))}),e+n*Math.max(0,r-1)}function c(n,r){var a=document.querySelector(".gridster > ul");if(a&&!(window.innerWidth<1280)){var o=r+(document.getElementById("infoWidget").getBoundingClientRect().height-n.clientHeight),c=Math.max(t*window.innerHeight,Math.min(o,i*window.innerHeight));null!==e&&Math.abs(c-e)<1||(e=c,a.style.setProperty("--top-row",Math.round(c)+"px"))}}this.graphHeight=function(){var t=r();if(!t)return 170;var i,e,n,a=o(t),h=(i=document.getElementById("activityGraph"),e=i?i.getBoundingClientRect().height:0,n=activity&&activity.options&&activity.options.height,e>0&&n&&e>=n?e-n:8);c(t,a+110+h);var u=t.clientHeight-a-h;return Math.round(Math.max(110,Math.min(170,u)))},this.run=function(){var t=r(),i=document.getElementById("activityGraph");if(t&&i&&activity&&activity.view&&activity.graph)if(i.classList.contains("is-empty")||i.classList.contains("is-sparse"))c(t,o(t)+i.getBoundingClientRect().height);else{var e=n.graphHeight();e!==activity.options.height&&(activity.options.height=e,activity.redraw())}};var h=null;function u(){h||(h=requestAnimationFrame(function(){h=null,n.run()}))}$(function(){var t=r();if(t&&window.ResizeObserver){var i=new ResizeObserver(u);i.observe(t),Array.prototype.forEach.call(t.children,function(t){i.observe(t)}),$(window).on("resize",u)}})};
