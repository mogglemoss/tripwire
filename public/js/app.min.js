...
tripwire.panels=function(){var t=[{id:"infoWidget",title:"System",defaultVisible:!0},{id:"signaturesWidget",title:"Signatures",defaultVisible:!0},{id:"notesWidget",title:"Notes",defaultVisible:!0},{id:"chainWidget",title:"Chain",defaultVisible:!0}];function e(){return options.panels||(options.panels={}),options.panels}function i(i){var n=e();if(Object.prototype.hasOwnProperty.call(n,i))return!!n[i];var l=function(e){for(var i=0;i<t.length;i++)if(t[i].id===e)return t[i];return null}(i);return!l||!1!==l.defaultVisible}function n(){t.forEach(function(t){$("#"+t.id).toggleClass("panel-hidden",!i(t.id))})}function l(t,i){e()[t]=!!i,n(),options.save()}return $(function(){t.forEach(function(t){var e=$("#"+t.id);if(e.length){var i=e.children(".controls").first();i.length&&!i.children(".panel-title").length&&(i.prepend($('<span class="panel-title"></span>').text(t.title)),$('<span class="panel-hide" role="button" tabindex="0" data-tooltip="Hide this panel">&times;</span>').on("click keydown",function(e){"keydown"===e.type&&"Enter"!==e.key&&" "!==e.key||(e.preventDefault(),l(t.id,!1))}).appendTo(i))}}),n()}),{all:function(){return t.slice()},isVisible:i,setVisible:l,toggle:function(t){l(t,!i(t))},apply:n}}();
