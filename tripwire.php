...
<head>
	...
	<link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Montserrat:wght@500;600;700&family=IBM+Plex+Sans:wght@400;500;600&family=IBM+Plex+Mono:wght@400;500&family=Geist:wght@400;500;600&family=Geist+Mono:wght@400;500;700&display=swap">
	<script>
	// Brand A/B for the preview: ?brand=observance | ?brand=corp, kept in
	// localStorage. Runs before the stylesheet paints so there is no flash.
	(function(){try{var q=new URLSearchParams(location.search).get('brand');if(q==='observance'||q==='corp'){localStorage.setItem('tripwire:brand',q);}var b=localStorage.getItem('tripwire:brand');if(b==='observance'){document.documentElement.setAttribute('data-brand','observance');}}catch(e){}})();
	</script>
